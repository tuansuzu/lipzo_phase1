...
<div class="container">
    <div class="row">
        ...
        {{Form::open(array('url'=>'mat-khau','class'=>'form-signin mg-btm'))}}
       
        <h3 class="heading-desc">
        <button type="button" class="close pull-right" aria-hidden="true">×</button>
        Đăng nhập với mật khẩu mới</h3>
       
        <div class="main">  
        
        <input type="password" name="password" class="form-control" placeholder="Mật khẩu" autofocus>
